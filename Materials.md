...
{% include notes.html file="ci-chains-en" name="notes" show=1 dot=1
%} {% include notebook.html file="ci-chains" name="colab" show=1 dot=1
...
{% include notes.html file="ci-motifs-en" name="notes" show=1 dot=0
%}
...
{% include notes.html file="ci-rna-en" name="notes" show=1 dot=0
%}
...
%} {% include notes.html file="ci-ilp-en" name="notes" show=1 dot=0
%} 
