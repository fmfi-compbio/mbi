...
%} {% if false %} BV chapter 1 {% endif %}

#### TI: Introduction to biology

{% include pdf.html file="ci-introbio-new" name="pdf" show=1 dot=1
...
{% include pdf.html file="cb-dp-code" name="pdf" show=0 dot=1
...
{% include pdf.html file="ci-bwt" name="pdf" show=0 dot=0
%}
...
{% include pdf.html file="p-aln2" name="pdf" show=0 dot=1
%} {% include youtube.html id="jkQGXiqKbxM" name="video" show=0 dot=1
%} {% if false %} BV chapter 2, DEKM chapter 2.5, 2.7, 6.1-6.3; ZB chapter 4.5-4.7, 5.3-5.5 {% endif %}

#### TI: Advanced algorithms for sequence alignment

{% include notes.html file="ci-aln1-en" name="notes (en, current)" show=0 dot=1
%} {% include notes.html file="ci-aln1" name="notes (sk, older)" show=0 dot=0
%}

#### TB: Programs for sequence alignment, scoring schemes, introduction to projects

{% include notes.html file="cb-aln2" name="notes" show=0 dot=1
%} {% if false %} [Projects](./Project.html) {% endif %}
...
%} {% if false %} BV chapter 4, DEKM chapter 3; ZB chapter 9.3, 10.4-10.7 {% endif %}

#### TI:  Fast similarity search, BLAST, MinHash

{% include notes.html file="ci-aln2-en" name="notes" show=0 dot=1
%} {% include pdf.html file="ci-aln2-en" name="pdf" show=0 dot=0
%}
...
%} {% if false %} BV chapter 3, DEKM chapter 7,8; ZB chapter 7, 8.1-8.2, video {% endif %}

#### TI:  Algorithms for HMM

{% include notes.html file="ci-hmm-en" name="notes (en)" show=0 dot=1
%} {% include notes.html file="ci-hmm" name="notes (sk, old)" show=0 dot=1
%} {% include pdf.html file="ci-hmm-en" name="pdf" show=0 dot=0
%}

#### TB: Substitution models, bootstrap, tree rooting

{% include notes.html file="cb-phylo1" name="notes" show=0 dot=1
...
%} {% if false %} BV chapter 5, ZB chapter 9.8, 10.8, {% endif %}
...
%} {% if false %} DEKM chapter 5.1, 11.5, ZB chapter 6.6,15.1,16.1-16.5,17.1 {% endif %}
...
{% include notes.html file="cb-uniprot" name="notes uniprot" show=0 dot=1
%} {% include notes.html file="cb-expr" name="notes k-means, enrichment" show=0 dot=1
%} {% include notes.html file="cb-expr2" name="notes enrichment2" show=0 dot=1
%} {% include pdf.html file="cb-kmeans" name="pdf kmeans" show=0 dot=0
%} 
...
%} {% if false %} DEKM chapter 5; ZB chapter 4.8-4.10, 6.1-6.2, 13.1-13.2 {% endif %}
...
{% include notes.html file="cb-grammars" name="notes grammars" show=0 dot=1
%} {% include notes.html file="cb-expr3" name="notes expression" show=0 dot=1
%} {% include notebook.html file="cb-expr" name="notebook expression" show=0 dot=1
%} {% include notes.html file="cb-prot" name="notes proteins" show=0 dot=0
%} 
...
%} {% if false %} DEKM chapter 10, ZB chapter 11.9 {% endif %}
...
%} {% include notes.html file="cb-grammars-en" name="notes grammar" show=0 dot=1
%} {% include notes.html file="ci-hmm2-en" name="notes HMMs" show=0 dot=0
%}

#### TB: Proteins, RNA structure, sequence motifs

<!-- proteiny, motivy, compgen, pripadne rna struktura -->
{% include notes.html file="cb-prot" name="notes proteins" show=0 dot=1
%} {% include notes.html file="cb-rna" name="notes rna" show=0 dot=1
%} {% include notes.html file="cb-motifs" name="notes motifs" show=0 dot=1
%} {% include notes.html file="cb-popgen" name="notes pop. genomics" show=0 dot=1
%} {% include notes.html file="cb-compgen" name="notes comp. genomics" show=0 dot=0
%}
...
{% include notes.html file="ci-rna-en" name="notes" show=0 dot=0
%}
...
%} {% include notes.html file="cb-linux" name="notes linux" show=0 dot=0
%} 
